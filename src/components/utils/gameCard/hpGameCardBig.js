...
import { COLOR_BDAZZLED_BLUE, COLOR_PLATINIUM, COLOR_OXFORD_BLUE } from '../color'
                ...
                >
                    <Grid>
                        <Grid
                            ...
                            <Grid item xs={12} style={{ maxWidth: "80%", textAlign: 'right' }}>
                                <Grid>
                                    <Typography
                                        sx={{
                                            textOverflow: "ellipsis",
                            ...
                            <Grid item xs={12} style={{ maxWidth: "20%", textAlign: 'right' }}>
                                <Grid container >
                                    <Grid item xs={12}>
                                        <Typography
                                            sx={{
